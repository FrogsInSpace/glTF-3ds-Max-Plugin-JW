...
#define vr_texmap_self_illumination 				_T("texmap_self_illumination") // texturemap (texmap_selfIllumination)
...
#define vr_texmap_metalness 						_T("texmap_metalness")  // texturemap
#define vr_texmap_metalness_on 						169 // boolean
#define vr_texmap_metalness_multiplier 			219 // float

#define vr_sheen_color								_T("sheen_color")				//  color
#define vr_sheen_glossiness							_T("sheen_glossiness")			//  float

#define vr_texmap_sheen								_T("texmap_sheen")				//  texturemap
#define vr_texmap_sheen_glossiness					_T("texmap_sheen_glossiness")	//  texturemap
#define vr_texmap_sheen_on							_T("texmap_sheen_on")			//  boolean
#define vr_texmap_sheen_multiplier					_T("texmap_sheen_multiplier")	//  float
#define vr_texmap_sheen_glossiness					_T("texmap_sheen_glossiness")	//  texturemap
#define vr_texmap_sheen_glossiness_on				_T("texmap_sheen_glossiness_on")//  boolean
#define vr_texmap_sheen_glossiness_multiplier		_T("texmap_sheen_glossiness_multiplier")	//  float



#define vr_coat_color							_T("coat_color")					//  color
#define vr_coat_amount							96					//  float
#define vr_coat_amount_Str						_T("coat_amount")					//  float
#define vr_coat_glossiness						98				//  float
#define vr_coat_glossiness_Str					_T("coat_glossiness")				//  float
#define vr_coat_ior								_T("coat_ior")						//  float
#define vr_coat_bump_lock						_T("coat_bump_lock")				//  boolean
#define vr_coat_bump_on							_T("coat_bump_on")					//  boolean
#define vr_coat_bump_multiplier					_T("coat_bump_multiplier")			//  float
#define vr_texmap_coat_color					_T("texmap_coat_color")				//  texturemap
#define vr_texmap_coat_color_on					_T("texmap_coat_color_on")			//  boolean
#define vr_texmap_coat_color_multiplier		_T("texmap_coat_color_multiplier")	//  float
#define vr_texmap_coat_amount					120	//  texturemap
#define vr_texmap_coat_amount_Str				_T("texmap_coat_amount")			//  texturemap
#define vr_texmap_coat_amount_on				_T("texmap_coat_amount_on")			//  boolean
#define vr_texmap_coat_amount_multiplier		_T("texmap_coat_amount_multiplier")	//  float
#define vr_texmap_coat_glossiness				121	//  texturemap
#define vr_texmap_coat_glossiness_Str			_T("texmap_coat_glossiness")		//  texturemap
#define vr_texmap_coat_glossiness_on			_T("texmap_coat_glossiness_on")		//  boolean
#define vr_texmap_coat_glossiness_multiplier	_T("texmap_coat_glossiness_multiplier")		//  float
#define vr_texmap_coat_ior						_T("texmap_coat_ior")				//  texturemap
#define vr_texmap_coat_ior_on					_T("texmap_coat_ior_on")			//  boolean
#define vr_texmap_coat_ior_multiplier			_T("texmap_coat_ior_multiplier")	//  float
#define vr_texmap_coat_bump						126 //  texturemap
#define vr_texmap_coat_bump_Str					_T("texmap_coat_bump")				//  texturemap
#define vr_texmap_coat_bump_on					_T("texmap_coat_bump_on")			//  boolean
#define vr_texmap_coat_bump_multiplier			226	//  float
#define vr_texmap_coat_bump_multiplier_Str		_T("texmap_coat_bump_multiplier")	//  float
...
#define crn_baseAnisoRotationTexmap		1	52	// texturemap
