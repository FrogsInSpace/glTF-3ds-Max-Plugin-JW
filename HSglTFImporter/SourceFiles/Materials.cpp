...
/*
BOOL CheckIfVRayInstalled(void)
{
	Mtl *p = (Mtl*)GetCOREInterface()->CreateInstance(MATERIAL_CLASS_ID, VRayMaterialID);
	return (p != NULL);
}
*/
...
//=============================================================================
//=============================================================================
int GetMapCh(cgltf_texture_view *texView)
{
	if (texView->has_transform) {
		if (texView->transform.has_texcoord) {
			return texView->transform.texcoord + 1;
		}
	}
...
//=============================================================================
//=============================================================================
void SetMapCh(Texmap* pTex, int mapCh)
{
	if (!pTex) return;
	UVGen* pUVGen = pTex->GetTheUVGen();
	if (pUVGen) pUVGen->SetMapChannel(mapCh);
}
*/
//=============================================================================
//=============================================================================
...
{
	tstring fname;
	//BOOL webp_flag = FALSE;
	//BOOL ktx2_flag = FALSE;
	originalFname.clear();
